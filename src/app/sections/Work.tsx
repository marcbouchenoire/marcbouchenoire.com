    ...
    <div className={clsx(className, "aspect-[1214/1702]")} {...props}>
      ...
      <div
        className={clsx(
          ...
          "absolute inset-[3%] right-0 bottom-[-3%] z-20 rounded-[4.615%/3.297%] rounded-bl-[3.077%_2.198%] bg-white"
        )}
      />
      <div
        className={clsx(
  ...
  return (
    <section {...props}>
      <div className="content content-lg">
        <div className="relative z-10 mb-5 flex flex-col rounded-lg bg-blue-500 shadow-blue-500/10 shadow-xl before:absolute before:inset-0 before:z-0 before:rounded-[inherit] before:bg-gradient-to-tl before:from-cyan-400/60 before:to-cyan-400/0 sm:mb-8 sm:flex-row lg:mb-10 dark:bg-blue-400 dark:shadow-blue-400/10 dark:before:from-cyan-300/60 dark:before:to-cyan-300/0">
          <div className="z-10 flex-1 p-8 selection:bg-white/30 sm:basis-1/2 sm:p-12 sm:pr-10 dark:selection:bg-blue-900/30">
            ...
            <p className="text-blue-100 leading-relaxed dark:text-blue-900/80">
              ...
              <a
                className="focusable rounded-sm font-medium underline decoration-2 decoration-blue-100/30 underline-offset-2 transition duration-100 hover:decoration-blue-100/50 focus-visible:ring-blue-100/30 dark:decoration-blue-900/20 dark:focus-visible:ring-blue-900/20 dark:hover:decoration-blue-900/40"
              ...
              <div className="perspective pointer-events-none absolute inset-0">
                <div
                  className={clsx(
                    ...
                    "pointer-events-auto absolute top-[-10%] right-[36%] aspect-[460/520] w-[30%] overflow-hidden rounded-[2.6087%/2.3077%] shadow-floaty lg:top-[-12%] lg:right-[8%] lg:w-[40%]"
                  )}
                >
                  <div
                    className={clsx(
                ...
                <Browser
                  className={clsx(
                    ...
                    "pointer-events-auto absolute right-[4%] bottom-[-10%] w-[50%] lg:right-0 lg:bottom-[-20%] lg:w-[56%]"
                  )}
                  popup
                  title="DevTools"
                >
                ...
                >
                  <div className="absolute top-[10.799%] right-[-17.9012%] z-10 aspect-[292/332] w-[45.0617%] overflow-hidden rounded-[4.1096%/3.6145%] shadow-floaty">
                    <Image
                      alt="An emoji picker"
                      className="absolute h-full w-full object-cover"
                      priority
              ...
              <div className="perspective pointer-events-none absolute inset-0">
                <Browser
                  className={clsx(
                    ...
                    "lg:-bottom-8 pointer-events-auto absolute bottom-0 left-0 w-[65%] lg:w-[75%]"
                  )}
                  title="liveblocks.io"
                >
              ...
              <div className="perspective pointer-events-none absolute inset-0">
                <Browser
                  className={clsx(
                    ...
                    "lg:-top-3 pointer-events-auto absolute top-0 right-0 w-[65%] lg:w-[75%]"
                  )}
                  title="liveblocks.io"
                >
                  <div className="relative aspect-[920/560] bg-black">
        ...
        <div className="relative mb-5 flex flex-col rounded-lg bg-sky-500 shadow-sky-500/10 shadow-xl before:absolute before:inset-0 before:z-0 before:rounded-[inherit] before:bg-gradient-to-tl before:from-cyan-400/80 before:to-cyan-400/0 sm:mb-8 sm:flex-row lg:mb-10 dark:bg-sky-400 dark:shadow-sky-400/10 dark:before:from-cyan-300/80 dark:before:to-cyan-300/0">
          <div className="z-10 flex-1 p-8 selection:bg-white/30 sm:basis-1/2 sm:p-12 sm:pr-10 dark:selection:bg-sky-900/30">
            ...
            <p className="text-sky-100 leading-relaxed dark:text-sky-900/80">
              ...
              <a
                className="focusable rounded-sm font-medium underline decoration-2 decoration-sky-100/30 underline-offset-2 transition duration-100 hover:decoration-sky-100/50 focus-visible:ring-sky-100/30 dark:decoration-sky-900/20 dark:focus-visible:ring-sky-900/20 dark:hover:decoration-sky-900/40"
          ...
          <div className="sm:-mr-12 lg:-mr-12 relative flex flex-1 items-center justify-center p-12 pt-0 pb-16 sm:basis-1/3 sm:p-0 lg:basis-1/2">
            <div className="perspective lg:-bottom-20 z-20 flex w-full max-w-sm items-center sm:absolute sm:inset-0 sm:max-w-none">
              <Browser
        ...
        <div className="relative my-5 flex flex-col rounded-lg bg-fuchsia-500 shadow-fuchsia-500/10 shadow-xl before:absolute before:inset-0 before:z-0 before:rounded-[inherit] before:bg-gradient-to-tl before:from-rose-400/60 before:to-rose-400/0 sm:my-8 sm:flex-row-reverse lg:my-10 dark:bg-fuchsia-400 dark:shadow-fuchsia-400/10 dark:before:from-rose-300/60 dark:before:to-rose-300/0">
          <div className="z-10 flex-1 p-8 selection:bg-white/30 sm:basis-1/2 sm:p-12 dark:selection:bg-fuchsia-900/30">
            ...
            <p className="text-fuchsia-100 leading-relaxed dark:text-fuchsia-900/80">
              I worked on{" "}
              <a
                className="focusable rounded-sm font-medium underline decoration-2 decoration-fuchsia-100/30 underline-offset-2 transition duration-100 hover:decoration-fuchsia-100/50 focus-visible:ring-fuchsia-100/30 dark:decoration-fuchsia-900/20 dark:focus-visible:ring-fuchsia-900/20 dark:hover:decoration-fuchsia-900/40"
              ...
              <div className="perspective pointer-events-none absolute inset-0">
                <Browser
                  className={clsx(
                    ...
                    "lg:-top-10 pointer-events-auto absolute top-0 left-0 w-[60%] lg:w-[80%]"
                  )}
                  title={
                    <>
                      framer.com
              ...
              <div className="perspective pointer-events-none absolute inset-0">
                <Browser
                  className={clsx(
                    ...
                    "lg:-bottom-2 pointer-events-auto absolute right-0 bottom-0 w-[80%]"
                  )}
                  title={
                    <>
                      framer.com
        ...
        <div className="relative mt-5 flex flex-col rounded-lg bg-orange-500 shadow-orange-500/10 shadow-xl before:absolute before:inset-0 before:z-0 before:rounded-[inherit] before:bg-gradient-to-tl before:from-yellow-400/60 before:to-yellow-400/0 sm:mt-8 sm:flex-row lg:mt-10 dark:bg-orange-300 dark:shadow-orange-400/10 dark:before:from-yellow-300/60 dark:before:to-yellow-300/0">
          <div className="z-10 flex-1 p-8 selection:bg-white/30 sm:basis-1/2 sm:p-12 sm:pr-10 dark:selection:bg-orange-900/30">
            ...
            <p className="text-orange-100 leading-relaxed dark:text-orange-900/80">
              ...
              <a
                className="focusable rounded-sm font-medium underline decoration-2 decoration-orange-100/30 underline-offset-2 transition duration-100 hover:decoration-orange-100/50 focus-visible:ring-orange-100/30 dark:decoration-orange-900/20 dark:focus-visible:ring-orange-900/20 dark:hover:decoration-orange-900/40"
          ...
          <div className="perspective max-sm:-mb-6 sm:-mr-12 relative z-20 flex flex-1 items-center justify-center sm:basis-1/3">
            <div
              className={clsx(
                styles.elementsTransform,
                "md:-top-16 mx-12 mt-0 mb-24 grid aspect-square w-full max-w-sm grid-cols-2 gap-8 sm:absolute sm:m-0 sm:max-w-[22rem] lg:top-[-5.5rem] lg:grid-cols-[1fr_1.2fr]"
              )}
            >
              <Phone
            ...
            <div className="perspective pointer-events-none relative z-20 aspect-[4/3] w-full max-w-sm bg-green-600/0 drop-shadow-floaty sm:absolute sm:max-w-none lg:aspect-[9/7]">
              ...
              <Phone
                className={clsx(
                  ...
                  "pointer-events-auto absolute top-[56%] right-[19%] w-[12%]"
                )}
                direction="left"
              >
                <video
              ...
              <Book
                className={clsx(
                  ...
                  "pointer-events-auto absolute top-[40%] right-0 w-[24%] text-[#f17a54]"
                )}
              >
                <Image
